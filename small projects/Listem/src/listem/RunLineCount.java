...
public class RunLineCount {
	...
	public static void main(String[] args) {
		...
		if (args.length == 2) {
			...
			System.out
					.println("USAGE: java listem.RunLineCount [-r] <dir> <file-pattern>");
			return;
		}
		 ...
		 */
		LineCounter counter = new LineCount();

		Map<File, Integer> lineCountResult = counter.countLines(new File(
				dirName), filePattern, recursive);
